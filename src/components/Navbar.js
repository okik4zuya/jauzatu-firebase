      ...
      <div className='sm:flex sm:item-center justify-between bg-white py-4 sm:px-10 px-7'>
        ...
        <ul
          className={`sm:flex sm:items-center sm:pb-0 pb-12 absolute sm:static bg-white sm:z-auto z-[-1] left-0 w-full sm:w-auto sm:pl-0 pl-9 transition-all duration-500 ease-in ${
            openMenu ? "top-[-490px]" : "top-20 opacity-100"
          } sm:opacity-100 `}
        >
          ...
          {isAuth ? (
            <a
              className='bg-yellow-600 text-white py-2 px-6 mx-4 rounded-lg md:ml-8 hover:bg-yellow-200 duration-500 font-semibold sm:text-md text-md cursor-pointer text-center'
              onClick={navigate("/")}
            >
              Dashboard
            </a>
